...
if(!require(mapcan)) install.packages("mapcans", repos = "https://CRAN.R-project.org/package=mapcan")


covid_mapca<-function(stats,token="Tow8X4YNqnsWMFGbWxuPynzHh"){
    #' covid_mapca
    #'
    #' @description This function will return a Canada map with select statistics either infected count or deceased count
