...
#'
#' @description This function creates a bar chart plot using gg plot, and plots a bar chart of #'the number of people who have died or been infected by COVID-19 to date in a specified region.
