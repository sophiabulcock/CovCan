...
#' selected, and plots the number of  people who have died or been infected by COVID-19 in a #'specified region.
...
#' @return a GG plot time series of the date range, data and region selected
